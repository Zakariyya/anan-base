...
(2,'Video_2018-01-13_181054.wmv',1,'D:\\Video_2018-01-13_181054.wmv',22,'22','102','2018-08-19 02:29:58','2019-01-01 17:35:36','file_DIR'),
...
CREATE TABLE `rbac_menu` (
  ...
  `module_name` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '模型名称',
  `name` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '菜单名称',
  `menu_type` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '菜单类型（BUTTON，MODELUE，PAGE）',
  `menu_url` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT 'controller',
  `icon` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '菜单图标',
  `is_show` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否显示（0：show，1：hide）',
  `order_no` int(11) NOT NULL DEFAULT '0' COMMENT '菜单排序（1，2，3）',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQUE` (`module_id`,`name`,`menu_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE `rbac_menu_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQUE` (`menu_id`,`role`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE `rbac_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `account` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '账号（唯一用于登陆）',
  `password` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '密码',
  `name` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '昵称',
  `sex` tinyint(1) NOT NULL DEFAULT '0' COMMENT '性别 0:man,1:woman',
  `email` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '电子邮件',
  `phone` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '电话',
  PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_uuid` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `telephone` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL,
  `role` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL,
  `image` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL,
  `last_ip` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL,
  `last_time` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
